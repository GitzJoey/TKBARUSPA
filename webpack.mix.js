...
mix.copy('resources/assets/js/apps/company.js', 'public/js/apps')
    ...
    .copy('resources/assets/js/apps/truck.js', 'public/js/apps')
    .copy('resources/assets/js/apps/role.js', 'public/js/apps')
    .copy('resources/assets/js/apps/truck_maintenance.js', 'public/js/apps')
    ...
    .minify('public/js/apps/truck.js')
    .minify('public/js/apps/role.js')
    .minify('public/js/apps/truck_maintenance.js')
    .minify('public/js/apps/phone_provider.js')
    .minify('public/js/apps/product_type.js')
    .minify('public/js/apps/warehouse_inflow.js')
    .version();