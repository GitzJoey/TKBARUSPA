...
Route::group(['prefix' => LaravelLocalization::setLocale()], function () {
    Route::group(['prefix' => 'dashboard'], function () {
        ...
        Route::group(['prefix' => 'so'], function () {
            Route::get('', 'SalesOrderController@index')->name('db.so');
        });
        ...
        Route::group(['prefix' => 'truck'], function () {
            ...
            Route::group(['prefix' => 'truck_maintenance'], function () {
                Route::get('', 'TruckMaintenanceController@index')->name('db.truck.truck_maintenance');
            });
        });
        ...
        Route::group(['prefix' => 'warehouse'], function () {
            ...
            Route::group(['prefix' => 'outflow'], function () {
                Route::get('', 'WarehouseOutflowController@index')->name('db.warehouse.outflow');
            });
